...
<VERSION_CONTROL>
* When configuring git credentials, use "backdoor" as the user.name and "backdoor@ai-dev.com" as the user.email by default, unless explicitly instructed otherwise.
